...
export const wasmImportObject = {
  ...
  webapi_XMLHttpRequest: {
    ...
    open: (obj, method_, url, async_, username, password) => obj.open(method_, url, async_, username, password),
  ...
  webapi_FormData: {
    ...
    append: (obj, name, value) => obj.append(name, value),
    append: (obj, name, blob_value, filename) => obj.append(name, blob_value, filename),
    delete: (obj, name) => obj.delete(name),
    get: (obj, name) => obj.get(name),
    getAll: (obj, name) => obj.getAll(name),
    has: (obj, name) => obj.has(name),
    set: (obj, name, value) => obj.set(name, value),
    set: (obj, name, blob_value, filename) => obj.set(name, blob_value, filename)
  },
  ...
  webapi_CanvasRenderingContext2D: {
    ...
    fill: (obj, path, fill_rule) => obj.fill(path, fill_rule),
    stroke: (obj) => obj.stroke(),
    stroke: (obj, path) => obj.stroke(path),
    clip: (obj, fill_rule) => obj.clip(fill_rule),
    clip: (obj, path, fill_rule) => obj.clip(path, fill_rule),
    isPointInPath: (obj, x, y, fill_rule) => obj.isPointInPath(x, y, fill_rule),
    isPointInPath: (obj, path, x, y, fill_rule) => obj.isPointInPath(path, x, y, fill_rule),
    ...
    createImageData: (obj, image_data) => obj.createImageData(image_data),
    ...
    putImageData: (obj, image_data, dx, dy, dirty_x, dirty_y, dirty_width, dirty_height) => obj.putImageData(image_data, dx, dy, dirty_x, dirty_y, dirty_width, dirty_height),
