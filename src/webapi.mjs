...
export const wasmImportObject = {
  ...
  webapi_Document: {
    ...
    open_window: (obj, url, name, features) => obj.open(url, name, features),
    close: (obj) => obj.close(),
  ...
  webapi_Window: {
    ...
    get: (obj, name) => obj[name],
    alert: (obj) => obj.alert(),
    alert_with_message: (obj, message) => obj.alert(message),
    ...
    scroll_xy: (obj, x, y) => obj.scroll(x, y),
    scrollTo: (obj, options) => obj.scrollTo(options),
    scroll_to_xy: (obj, x, y) => obj.scrollTo(x, y),
    ...
    create_image_bitmap_cropped: (obj, image, sx, sy, sw, sh, options) => obj.createImageBitmap(image, sx, sy, sw, sh, options),
  ...
  webapi_XMLHttpRequest: {
    ...
    open_with_credentials: (obj, method_, url, async_, username, password) => obj.open(method_, url, async_, username, password),
  ...
  webapi_FormData: {
    ...
    append: (obj, name, value) => obj.append(name, value),
    append_blob: (obj, name, blob_value, filename) => obj.append(name, blob_value, filename),
    delete: (obj, name) => obj.delete(name),
    get: (obj, name) => obj.get(name),
    getAll: (obj, name) => obj.getAll(name),
    has: (obj, name) => obj.has(name),
    set: (obj, name, value) => obj.set(name, value),
    set_blob: (obj, name, blob_value, filename) => obj.set(name, blob_value, filename)
  },
  ...
  webapi_HTMLInputElement: {
    ...
    set_range_text_in_range: (obj, replacement, start, end, selection_mode) => obj.setRangeText(replacement, start, end, selection_mode),
  ...
  webapi_HTMLSelectElement: {
    ...
    add: (obj, element, before) => obj.add(element, before),
    remove: (obj) => obj.remove(),
    remove_at: (obj, index) => obj.remove(index),
    set: (obj, index, option) => { obj[index] = option; },
    checkValidity: (obj) => obj.checkValidity(),
    reportValidity: (obj) => obj.reportValidity(),
    setCustomValidity: (obj, error) => obj.setCustomValidity(error),
  ...
  webapi_CanvasRenderingContext2D: {
    ...
    set_transform_matrix: (obj, transform) => obj.setTransform(transform),
    ...
    fill_path: (obj, path, fill_rule) => obj.fill(path, fill_rule),
    stroke: (obj) => obj.stroke(),
    stroke_path: (obj, path) => obj.stroke(path),
    clip: (obj, fill_rule) => obj.clip(fill_rule),
    clip_path: (obj, path, fill_rule) => obj.clip(path, fill_rule),
    isPointInPath: (obj, x, y, fill_rule) => obj.isPointInPath(x, y, fill_rule),
    is_point_in_path_with_path: (obj, path, x, y, fill_rule) => obj.isPointInPath(path, x, y, fill_rule),
    isPointInStroke: (obj, x, y) => obj.isPointInStroke(x, y),
    is_point_in_stroke_with_path: (obj, path, x, y) => obj.isPointInStroke(path, x, y),
    drawFocusIfNeeded: (obj, element) => obj.drawFocusIfNeeded(element),
    draw_focus_if_needed_path: (obj, path, element) => obj.drawFocusIfNeeded(path, element),
    ...
    draw_image_scaled: (obj, image, dx, dy, dw, dh) => obj.drawImage(image, dx, dy, dw, dh),
    draw_image_cropped: (obj, image, sx, sy, sw, sh, dx, dy, dw, dh) => obj.drawImage(image, sx, sy, sw, sh, dx, dy, dw, dh),
    createImageData: (obj, sw, sh, settings) => obj.createImageData(sw, sh, settings),
    create_image_data_from: (obj, image_data) => obj.createImageData(image_data),
    ...
    put_image_data_dirty_rect: (obj, image_data, dx, dy, dirty_x, dirty_y, dirty_width, dirty_height) => obj.putImageData(image_data, dx, dy, dirty_x, dirty_y, dirty_width, dirty_height),
  ...
  webapi_DataTransferItemList: {
    ...
    add_file: (obj, data) => obj.add(data),
    remove: (obj, index) => obj.remove(index),
    clear: (obj) => obj.clear()
  },
  ...
  webapi_ImageData: {
    ...
    new_from_array: (data, sw, sh, settings) => new ImageData(data, sw, sh, settings),
    get_width: (obj) => obj.width,
    get_height: (obj) => obj.height,
    get_data: (obj) => obj.data,
