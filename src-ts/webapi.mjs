...
export const wasmImportObject = {
  ...
  webapi_Document: {
    ...
    open2: (obj, url, name, features) => obj.open(url, name, features),
    close: (obj) => obj.close(),
  ...
  webapi_Window: {
    ...
    scroll2: (obj, x, y) => obj.scroll(x, y),
    scrollTo: (obj, options) => obj.scrollTo(options),
    scrollTo2: (obj, x, y) => obj.scrollTo(x, y),
    scrollBy: (obj, options) => obj.scrollBy(options),
    scrollBy2: (obj, x, y) => obj.scrollBy(x, y),
    ...
    alert: (obj) => obj.alert(),
    alert2: (obj, message) => obj.alert(message),
    ...
    postMessage2: (obj, message, options) => obj.postMessage(message, options),
    captureEvents: (obj) => obj.captureEvents(),
    releaseEvents: (obj) => obj.releaseEvents(),
    ...
    createImageBitmap2: (obj, image, sx, sy, sw, sh, options) => obj.createImageBitmap(image, sx, sy, sw, sh, options),
  ...
  webapi_HTMLInputElement: {
    ...
    setRangeText2: (obj, replacement, start, end, selectionMode) => obj.setRangeText(replacement, start, end, selectionMode),
  ...
  webapi_CanvasRenderingContext2D: {
    ...
    setTransform2: (obj, transform) => obj.setTransform(transform),
    ...
    fill2: (obj, path, fillRule) => obj.fill(path, fillRule),
    stroke: (obj) => obj.stroke(),
    stroke2: (obj, path) => obj.stroke(path),
    clip: (obj, fillRule) => obj.clip(fillRule),
    clip2: (obj, path, fillRule) => obj.clip(path, fillRule),
    isPointInPath: (obj, x, y, fillRule) => obj.isPointInPath(x, y, fillRule),
    isPointInPath2: (obj, path, x, y, fillRule) => obj.isPointInPath(path, x, y, fillRule),
    isPointInStroke: (obj, x, y) => obj.isPointInStroke(x, y),
    isPointInStroke2: (obj, path, x, y) => obj.isPointInStroke(path, x, y),
    drawFocusIfNeeded: (obj, element) => obj.drawFocusIfNeeded(element),
    drawFocusIfNeeded2: (obj, path, element) => obj.drawFocusIfNeeded(path, element),
    ...
    drawImage2: (obj, image, dx, dy, dw, dh) => obj.drawImage(image, dx, dy, dw, dh),
    drawImage3: (obj, image, sx, sy, sw, sh, dx, dy, dw, dh) => obj.drawImage(image, sx, sy, sw, sh, dx, dy, dw, dh),
    createImageData: (obj, sw, sh, settings) => obj.createImageData(sw, sh, settings),
    createImageData2: (obj, imageData) => obj.createImageData(imageData),
    ...
    putImageData2: (obj, imageData, dx, dy, dirtyX, dirtyY, dirtyWidth, dirtyHeight) => obj.putImageData(imageData, dx, dy, dirtyX, dirtyY, dirtyWidth, dirtyHeight),
